        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          ...
          >
            ...
            <p className="mt-4 text-muted-foreground">
              Con más de 15 años de experiencia en el mundo de la costura y confección, Entre Costuras nació de la
              pasión por crear prendas únicas y de calidad.
            </p>
            <p className="mt-4 text-muted-foreground">
              Comenzamos como un pequeño taller familiar y hoy nos enorgullece ser reconocidos por nuestra dedicación,
              profesionalismo y atención personalizada a cada cliente.
            </p>
            <div className="mt-8 flex gap-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm text-muted-foreground">Prendas confeccionadas</span>
              </div>
            </div>
          </motion.div>
          <motion.div
