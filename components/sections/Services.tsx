        ...
        <div className="container-content">
          <div className="mx-auto max-w-[800px] text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              Ofrecemos una amplia gama de servicios de costura y confección
              para satisfacer todas tus necesidades. Desde arreglos simples
              hasta diseños personalizados.
            </p>
          </div>
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-2 overflow-hidden">
